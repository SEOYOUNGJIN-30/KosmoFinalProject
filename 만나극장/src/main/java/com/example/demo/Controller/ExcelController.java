...
public class ExcelController {
    ...
    public void downloadExcelThunder(HttpServletResponse response) throws IOException {
        ...
        headerRow.createCell(8).setCellValue("장소");
        headerRow.createCell(9).setCellValue("태그");
        headerRow.createCell(10).setCellValue("주소");
        headerRow.createCell(11).setCellValue("이미지링크");
        headerRow.createCell(12).setCellValue("오픈링크");
        ...
        for (ExcelThunder thunder : list) {
            ...
            row.createCell(4).setCellValue(thunder.getCategory());
            row.createCell(5).setCellValue(thunder.getLat());
            row.createCell(6).setCellValue(thunder.getLng());
            row.createCell(7).setCellValue(thunder.getRegdate());
            row.createCell(8).setCellValue(thunder.getLocation());
            row.createCell(9).setCellValue(thunder.getTags());
            row.createCell(10).setCellValue(thunder.getAddress());
            row.createCell(11).setCellValue(thunder.getImage());
            row.createCell(12).setCellValue(thunder.getOpenlink());
        }
        response.setContentType("ms-vnd/excel");
        response.setHeader("Content-Disposition", "attachment;filename=MeetCinema_ThunderBoard.xls");
