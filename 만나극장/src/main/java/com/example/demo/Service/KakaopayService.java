...
//    private CartMapper cartMapper;
    ...
    public String ReadyVO(String partner_order_id) {
        ...
        try {
//          ReadyVO = restTemplate.postForObject(HOST + url, body, KakaoPayReadyVO.class);
            ReadyVO = restTemplate.postForObject(HOST + url, body, ReadyDTO.class);

//          kakaoReadyMapper.insertReady(PayReadyVO);
...
//          response.put("next_redirect_pc_url", ReadyVO.getNext_redirect_pc_url());
